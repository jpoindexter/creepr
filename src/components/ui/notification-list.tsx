...
export const NotificationList = React.forwardRef<HTMLDivElement, NotificationListProps>(
  (
    ...
    if (error) {
      return (
        <div className={cn(mode.color.text.danger, "p-6", className, "")}>
    ...
    return (
      <div ref={ref} className={cn("", className, "")} {...props}>
        {notifications.length === 0 ? (
          <div className="text-muted-foreground p-8 text-center">No notifications</div>
        ) : (
                ...
                <div className={`flex gap-6`}>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {notification.description && (
                      <p className="text-muted-foreground line-clamp-2 text-sm transition-colors">
                        {notification.description}
                      </p>
                    )}
                    <p className="text-muted-foreground mt-2 text-xs transition-colors">
                      {notification.time}
                    </p>
                  </div>
                  {onDismiss && (
                    <Button
                      ...
                      className={cn(
                        ...
                        "hover:text-destructive focus-visible:ring-ring transition-all hover:scale-110 focus-visible:ring-2 focus-visible:outline-none"
                      )}
